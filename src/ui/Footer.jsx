    ...
    return (
        <footer className='footer'>
            ...
            <div className='footer-about'>
                ...
                <p>Fabbella ozbekistondagi ayollar hamda qizlar uchun online do'/kon bolib siz unda <Link to="/admin/login"> ozinggizga </Link> yoqqan mahsulotlarni online tarzda xarid qilishingiz mumkin. Yetkazib berish xizmati bizda har doim mavjud 😊❤️ </p>
